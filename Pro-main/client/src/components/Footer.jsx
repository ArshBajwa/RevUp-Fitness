   ...
   <footer className="relative w-full">
      <div className="mx-auto w-full max-w-7xl px-8 sticky">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-white-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/"><span className='text-pink-500'>RevUP Fitness</span></a>. All
            Rights Reserved.
          </Typography>
